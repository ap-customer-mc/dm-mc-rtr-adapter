    ...
    module Soap
      ...
      class Connection
        ...
        def initialize(options)
          ...
          savon_ops = { wsdl: "#{Rails.root}#{@wsdl_path}", ssl_cert_key_file: "#{Rails.root}/#{@ssl_key}", ssl_cert_file: "#{Rails.root}/#{@ssl_cert}", logger: Rails.logger, log_level: :info, log: true,  pretty_print_xml: true}
          auth_ops = {}
